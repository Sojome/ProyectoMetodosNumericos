...
public class Biseccion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Biseccion - Aaron Jaramillo");
	...
	double [] FXM = new double[intentos];
        ...
        for(int i=0; i<intentos; i++)
        {
            ...
            yano[1]=CKambio(XI[i]);
            yano[2]=CKambio(XD[i]);
            yano[3]=CKambio(FXI[i]);
            yano[4]=CKambio(FXD[i]);
            yano[5]=CKambio(XM[i]);
            yano[6]=CKambio(FXM[i]);
